...
import { Icon, Button as SemButton } from 'semantic-ui-react';
        ...
        <Row className="justify-content-end">
          <Col xs={3}>
            <div className="btn-block d-flex justify-content-end">
              ...
              {/* <SemButton circular icon color="blue" size="large">
                <Icon name="bell" />
              </SemButton> */}
              <SemButton
                color="blue"
        ...
        <Row className="justify-content-center mb-5">
          <Col md={10} lg={8}>
            ...
            <p className="text-muted mt-3">
              Connecting NGOs, rural women entrepreneurs, and corporations to create impactful CSR
              initiatives.
            </p>
            <div className="mt-4">
          ...
          <Row className="g-4">
            <Col md={4}>
              ...
              <p className="text-muted">
                NGOs organize CSR initiatives and showcase participating rural businesses
              </p>
            </Col>
            <Col md={4}>
              ...
              <p className="text-muted">
                Rural women entrepreneurs showcase their products and services
              </p>
            </Col>
            <Col md={4}>
              ...
              <p className="text-muted">
                Corporations discover and partner with promising rural businesses
              </p>
            </Col>
          </Row>
        </section>
